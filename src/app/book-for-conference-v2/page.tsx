...
export const metadata: Metadata = {
  ...
  description:
    "Fast-track a meeting with CustomerCare.OM's leadership at regional technology events.",
};
  ...
  return (
    <>
      <PageHero
        ...
        sub="Attending the same event as CustomerCare.OM? Book a private 15-minute session with our founders, live agent demo included, coffee provided."
        cta={false}
      />
