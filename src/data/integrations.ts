...
export const integrations: Integration[] = [
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "One base per agent or a shared table",
        ],
      },
      {
        h: "Data residency for Oman",
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        h: "Data residency for Oman",
        p: [
          "ClickSend receives only the destination number and the rendered message text. Call recordings and transcripts never pass through the SMS pipeline and remain hosted in Oman under our Personal Data Protection Law controls.",
        ],
      },
    ],
    capabilities: [
  ...
  {
    slug: "pipedrive-ai-customer-care-integration",
    name: "Pipedrive",
    category: "CRM",
  ...
  {
    slug: "salesforce-ai-customer-care-integration",
    name: "Salesforce",
    category: "CRM",
