...
export const templates: Template[] = [
  {
    slug: "appointment-scheduling-for-contractors-with-voice-ai",
    name: "Contractor Appointment Scheduling",
    industry: "Construction & Home Services",
    short: "Let an AI phone agent book site visits, quotes, and repair jobs for your contracting business around the clock.",
    featured: true,
    sections: [
      {
        ...
        bullets: [
          "Answers 24/7, including Fridays and public holidays",
          "Books directly into Google Calendar, Outlook, or your job-management tool",
          "Captures job details so your team arrives prepared",
        ],
      },
      {
    ...
    steps: [
      "Greet the caller in their language and identify the type of job they need",
      "Collect the property location, access details, and urgency level",
      "Check the live calendar and offer the two nearest available slots",
      "Confirm the booking and read back the date, time, and address",
      "Send an SMS or WhatsApp confirmation and log the job details for the crew",
    ],
  },
  {
    ...
    sections: [
      {
        ...
        bullets: [
          "Separates urgent repairs from routine maintenance automatically",
          "Records pool size, type, and problem description for the technician",
          "Offers contract renewals to existing customers during the call",
        ],
      },
      {
        h: "The Omani teams that run it",
    ...
    steps: [
      "Answer the call and determine whether it is a repair, routine service, or new enquiry",
      "Collect the pool location, pool type, and a description of the issue",
      "Classify urgency and, for emergencies, offer the earliest same-day slot",
      "Book the technician visit against live availability",
      "Confirm the appointment by SMS and create a job ticket with all details",
    ],
  },
  {
    ...
    sections: [
      {
        ...
        bullets: [
          "Categorised ticketing for plumbing, electrical, AC, lifts, and common areas",
          "Instant escalation path for fire, flood, and lift entrapment calls",
          "Answers routine tenant questions from your building handbook",
        ],
      },
      {
        h: "The Omani teams that run it",
      ...
      },
      {
        h: "Setup",
        p: [
          "Import your building list and unit numbers, define your ticket categories and escalation contacts, and upload your tenant handbook. The agent can cover one tower or an entire portfolio from a single number.",
        ],
      },
    ],
    steps: [
      "Greet the tenant, confirm the building and unit number",
      "Identify the issue category and gather a clear description",
      "Check for emergency conditions and escalate to on-call staff if needed",
      "Create a maintenance ticket and give the tenant a reference number",
      "State the expected response window and send a confirmation message",
      "Notify the assigned maintenance team with the full ticket details",
    ],
  },
  {
    ...
    sections: [
      {
        ...
        bullets: [
          "Confirmation calls one to three days before each appointment",
          "Instant rescheduling against your crew's live availability",
          "Preparation reminders reduce repeat visits",
        ],
      },
      {
        h: "The Omani teams that run it",
      ...
      },
      {
        h: "Setup",
        p: [
          "Connect your appointment calendar, set how many days before each visit the agent should call, and customise the preparation checklist. Outcomes sync back automatically so your dispatch board always reflects reality.",
        ],
      },
    ],
    steps: [
      "Call the customer and confirm identity and the upcoming appointment",
      "Ask whether the scheduled date and time still works",
      "If not, offer alternative slots and rebook immediately",
      "Remind the customer of preparation items such as roof access",
      "Update the calendar and CRM with confirmed, rescheduled, or unreachable status",
    ],
  },
  {
    slug: "voice-ai-ticketing-system-for-ecommerce-businesses",
    name: "E-commerce Support Ticketing",
    ...
    sections: [
      {
        ...
        bullets: [
          "Live order lookups by order number or registered phone number",
          "Automatic categorisation into delivery, return, refund, or product issues",
          "Full call summaries attached to every ticket",
        ],
      },
      {
        h: "The Omani teams that run it",
      ...
      },
      {
        h: "Setup",
        p: [
          "Connect your store platform and helpdesk, map your issue categories, and define which issues the agent may resolve directly versus ticket for your team. Billing is in OMR and scales with call volume.",
        ],
      },
    ],
    steps: [
      "Answer the call and ask for the order number or registered phone number",
      "Retrieve the order and confirm the item and delivery status with the caller",
      "Identify the issue type and collect the relevant details",
      "Resolve status enquiries directly, or create a categorised ticket",
      "Give the customer a ticket reference and expected resolution time",
    ],
  },
  {
    slug: "voice-ai-product-info-template-for-ecommerce",
    name: "E-commerce Product Information",
    industry: "E-commerce & Retail",
    ...
    sections: [
      {
        ...
        bullets: [
          "Answers drawn from your live catalogue, not a static script",
          "Stock and delivery-time checks during the call",
          "Sends product links via SMS or WhatsApp to close the sale",
        ],
      },
      {
        h: "The Omani teams that run it",
      ...
      },
      {
        h: "Setup",
        p: [
          "Sync your product feed or upload a catalogue file, set your delivery zones and times, and choose whether the agent should capture leads, send purchase links, or both.",
        ],
      },
    ],
    steps: [
      "Greet the caller and identify which product or category they are asking about",
      "Answer specification, price, and compatibility questions from the catalogue",
      "Check current stock and quote realistic delivery times for the caller's area",
      "Suggest an alternative product if the requested item is unavailable",
      "Send a purchase link by SMS or WhatsApp, or log the enquiry as a lead",
    ],
  },
  {
    ...
    sections: [
      {
        ...
        bullets: [
          "Qualification on budget, move-in timeline, and financing status",
          "Viewing appointments booked straight into agent calendars",
          "Every enquiry logged against the specific listing that triggered it",
        ],
      },
      {
        h: "The Omani teams that run it",
      ...
      },
      {
        h: "Setup",
        p: [
          "Import your active listings, define your qualification questions and scoring, and connect your CRM and agent calendars. Each listing can have its own dedicated tracking number.",
        ],
      },
    ],
    steps: [
      "Answer the call and identify which property the caller is asking about",
      "Share headline details: price, size, location, and availability",
      "Qualify the caller on budget, timeline, financing, and requirements",
      "Score the lead and book a viewing for qualified prospects",
      "Log the full enquiry in the CRM and notify the assigned agent",
    ],
  },
  {
    ...
    sections: [
      {
        ...
        bullets: [
          "Books by treatment type and practitioner availability",
          "Enforces deposit and cancellation policies consistently",
      ...
      },
      {
        h: "Setup",
        p: [
          "Load your treatment menu, practitioner schedules, and booking policies, then connect your clinic calendar or management software. The agent never gives medical advice; clinical questions are routed to your staff.",
        ],
      },
    ],
    steps: [
      "Greet the caller warmly and identify the treatment or consultation they want",
      "Answer high-level questions about duration, preparation, and pricing",
      "Offer available slots with the appropriate practitioner",
      "Confirm the booking and explain the deposit and cancellation policy",
      "Send a confirmation and schedule an automated reminder before the visit",
    ],
  },
  {
    ...
    sections: [
      {
        ...
        bullets: [
          "Structured qualification on income, employment, and property status",
          "Clear explanation of required documents before the first meeting",
          "Qualified leads booked directly into advisor calendars",
        ],
      },
      {
        h: "The Omani teams that run it",
      ...
      },
      {
        h: "Setup",
        p: [
          "Define your qualification criteria and scoring thresholds, upload your document checklist, and connect your CRM. You control exactly which questions the agent asks and where the answers go.",
        ],
      },
    ],
    steps: [
      "Greet the caller and confirm they are enquiring about home financing",
      "Collect employment type, income range, and residency status",
      "Ask about the property: identified or still searching, price range, and location",
      "Score the lead against your qualification criteria",
      "Book qualified leads with an advisor and send the document checklist",
      "Log unqualified enquiries with reasons for future nurture campaigns",
    ],
  },
  {
    ...
    sections: [
      {
        ...
        bullets: [
          "Instant answers on availability, rent, and lease terms",
          "Viewing slots booked against your schedule",
          "Pre-viewing screening questions you define",
        ],
      },
      {
        h: "The Omani teams that run it",
      ...
      },
      {
        h: "Setup",
        p: [
          "Upload your available units with rents, terms, and photos links, set your viewing schedule, and choose your screening questions. When a unit is let, mark it taken and the agent updates its answers instantly.",
        ],
      },
    ],
    steps: [
      "Answer the call and identify which unit or listing the caller means",
      "Confirm availability and quote the rent, terms, and included services",
      "Ask screening questions about move-in date, occupants, and employment",
      "Offer viewing slots and book a time with qualified callers",
      "Send the viewing confirmation with the property location by SMS",
    ],
  },
  {
    ...
    sections: [
      {
        ...
        bullets: [
          "Structured new-matter intake by practice area",
          "Urgent matters escalated to the duty lawyer immediately",
          "Consultations booked with the correct fee expectations set",
        ],
      },
      {
        h: "The Omani teams that run it",
      ...
      },
      {
        h: "Setup",
        p: [
          "List your practice areas, lawyers, and consultation fees, define escalation rules for urgent matters, and connect your calendars. The intake script can mirror your existing paper intake form exactly.",
        ],
      },
    ],
    steps: [
      "Answer with the firm's greeting and determine if the caller is a new or existing client",
      "For new matters, capture the matter type, key parties, and a brief summary",
      "Check the matter against the firm's practice areas and urgency rules",
      "Escalate urgent matters to the duty lawyer, or book a consultation",
      "Set fee expectations for the consultation and confirm the booking",
      "Deliver a full intake summary to the assigned lawyer before the meeting",
    ],
  },
  {
    ...
    sections: [
      {
        ...
        bullets: [
          "Unhurried, judgment-free booking experience",
          "Crisis-aware call handling with immediate escalation paths",
          "Discreet reminders that respect client privacy",
        ],
      },
      {
        h: "The Omani teams that run it",
    ...
    sections: [
      {
        ...
        bullets: [
          "Product identification across motor, health, property, and business lines",
          "Renewal dates captured for perfectly timed callbacks",
          "Hot leads routed to producers while intent is high",
        ],
      },
      {
        h: "The Omani teams that run it",
      ...
      },
      {
        h: "Setup",
        p: [
          "Select the product lines you sell, tune the qualification questions per product, and connect your CRM and producer calendars. Pricing is in OMR and scales with your call volume, not your headcount.",
        ],
      },
    ],
    steps: [
      "Answer the call and identify which insurance product the caller needs",
      "Gather qualifying details: the insured item or persons, current cover, and renewal date",
      "Ask about budget expectations and any past claims relevant to quoting",
      "Score the lead and route hot prospects to a producer or book a callback",
      "Log every enquiry in the CRM with the renewal date for timed follow-up",
    ],
  },
];
